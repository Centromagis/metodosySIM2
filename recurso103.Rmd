...
La probabilidad es un número entre cero y uno que se asigna a cada resultado de un evento aleatorio, mediante diferentes enfoques.  A continuación se definen los enfoques:
...
En la gran mayoría de casos no se cumplen los supuestos anteriores (eventos equiprobables o con igual probabilidad), pues se tienen eventos con diferentes probabilidades, lo cual impide que podamos utilizar el enfoque clásico. 
